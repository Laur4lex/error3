class Cuento {
  ...
  dibujar() {
    ...
    this.reiniciar = false;
      ...
      this.boton.botonRosa(500, 80, 50, 0);
    ...
    if (this.pantallas == 0) {
      ...
      push();
      this.boton.botonRosa(470, 520, 50, 41);
      fill(0);
      textSize(25);
      text("Juego", 437, 520);
      pop();
    ...
    if (this.pantallas == 46) {
      ...
      this.camino=1;
      this.boton.boton(140, 400, 50, 47);
      this.boton.boton(460, 400, 50, 50);
    ...
    if (this.pantallas == 3) {
      ...
      this.boton.boton(140, 400, 50, 4 );
      this.boton.boton(300, 400, 50, 9);
      this.boton.boton(460, 400, 50, 22);
    ...
    if (this.pantallas == 11) {
      ...
      this.boton.boton(140, 400, 50, 12 );
      this.boton.boton(460, 400, 50, 16);
    ...
    if (this.pantallas == 23) {
      ...
      this.boton.boton(140, 400, 50, 24 );
      this.boton.boton(460, 400, 50, 37);
    ...
    if (this.pantallas == 27) {
      ...
      this.boton.boton(140, 400, 50, 28 );
      this.boton.boton(460, 400, 50, 34);
    ...
    if (this.pantallas == 28) {
      ...
      this.boton.boton(240, 400, 50, 29 );
      this.boton.boton(360, 400, 50, 32);
